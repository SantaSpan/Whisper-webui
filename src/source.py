...
def get_audio_source_collection(path:str, urlData: str, multipleFiles: List, microphoneData: str, input_audio_max_duration: float = -1) -> List[AudioSource]:
    output: List[AudioSource] = []
    if path:
        output.append(AudioSource(path))
    # if urlData:
